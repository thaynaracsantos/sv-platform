        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          >
                  ...
                  {authorDetails.map((author) => (
                    <li className="flex items-center space-x-2" key={author.name}>
                      ...
                      <dl className="whitespace-nowrap text-sm font-medium leading-5">
                        ...
                        <dd className="text-pink-900 dark:text-pink-100">{author.name}</dd>
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              ...
              <div className="pt-6 pb-6 text-sm text-pink-700 dark:text-pink-300">
              ...
              <div className="divide-gray-200 text-sm font-medium leading-5 dark:divide-gray-700 xl:col-start-1 xl:row-start-2 xl:divide-y">
                {tags && (
                  <div className="py-4 xl:py-8">
                    <h2 className="text-xs uppercase tracking-wide text-pink-500 dark:text-pink-400">
                      Tags
                    </h2>
